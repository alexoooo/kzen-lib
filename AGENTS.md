...
- **Composite-build umbrella context** — see [`../kzen/AGENTS.md`](../kzen/AGENTS.md) for toolchain pins (Kotlin 2.4.0, JVM 25 toolchain/target, kotlin-wrappers ceiling), the IntelliJ run/debug Provided-scope bug, and the umbrella↔mavenLocal interplay.
